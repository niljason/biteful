...
// POST /users
void UserRest::create(const HttpRequestPtr &req,
...
// GET /users/{id}
void UserRest::getOne(const HttpRequestPtr &req,
                      std::function<void(const HttpResponsePtr &)> &&callback,
                      std::string &&id)
{
    auto dbClient = app().getDbClient();
...
void UserRest::updateOne(const HttpRequestPtr &req,
                         std::function<void(const HttpResponsePtr &)> &&callback,
                         std::string &&id)
{
    auto resp = HttpResponse::newHttpResponse();
...
void UserRest::deleteOne(const HttpRequestPtr &req,
                         std::function<void(const HttpResponsePtr &)> &&callback,
                         std::string &&id)
{
    auto dbClient = app().getDbClient();
