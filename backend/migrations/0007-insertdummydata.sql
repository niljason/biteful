...
VALUES (40365904, 'The Healthy Bite', 'MANHATTAN', '123', 'GREENWICH ST', '10001', '2125550199', 'Healthy', 'A');
...
VALUES 
    ((SELECT id FROM menus WHERE restaurant_id = 40365904 LIMIT 1), 'Avocado Smash', -30, 'Breakfast', 14.50),
    ((SELECT id FROM menus WHERE restaurant_id = 40365904 LIMIT 1), 'Classic Burger', -10, 'Main', 16.00),
    ((SELECT id FROM menus WHERE restaurant_id = 40365904 LIMIT 1), 'Kale Salad', 20, 'Salads', 12.00);
